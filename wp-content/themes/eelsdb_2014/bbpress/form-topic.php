        ...
        <h3>
				...
				<div>
					...
					<div class="form-group">
						...
						<input class="form-control bbpress-input-narrow" type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</div>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<div class="form-group">
							...
							<input class="form-control bbpress-input-narrow" type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> />
						</div>
            ...
            <hr>
						...
						<div class="form-group">
							...
							<input class="form-control bbpress-input-narrow" type="text" value="<?php bbp_form_topic_edit_reason(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_edit_reason" id="bbp_topic_edit_reason" />
						</div>
...
<script type="text/javascript">
  jQuery(function ($) {
    $('.form-group select').addClass('form-control bbpress-input-narrow');
  });
</script>
